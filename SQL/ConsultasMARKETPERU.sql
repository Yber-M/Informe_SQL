...
-- precio unitario promedio de todos los productos que corresponda a la categor�a 2
...
-- Clausula group by
-- cantidad de productos registrados para cada categor�a
...
-- cantidad de productos por proveedor para la categor�a de 2 y 4
select 
...
-- gu�a de remision n�mero 27 y adem�s su monto total
...
-- despacharon en la fecha que se despacho la �ltima salida del almacen
-- Tenga en cuenta que en dicha fecha se puede haber registrado m�s de un salida

-- Fehca de la �ltima salida
